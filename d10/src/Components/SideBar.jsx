    ...
    <div className="col d-none d-md-block col-sm-3 col-lg-2 col-xxl-2 full-screen-height p-0">
      <div className="sidebar-div  d-flex flex-column">
        ...
        <div className="d-none d-md-block d-lg-none">
          ...
          <div className="position-relative" style={{ marginLeft: "34px", width: "70%" }}>
            <div className="d-flex justify-content-between">
              <div className="d-flex flex-column">
                <h6 style={{ fontWeight: "500" }}>ZITTI E BUONI</h6>
                <p style={{ fontSize: "small" }}>Måneskin</p>
              </div>
              <div id="heart-container0" /* onClick="changeHeart0()" */>
                <i id="heart0" className="bi bi-heart" style={{ fontSize: "1.5rem" }}></i>
              </div>
            </div>
          </div>
          <div className="slide-container-music px-1" style={{ marginLeft: "30px", marginBottom: "10px", width: "80%", height: "1px" }}>
            <Form>
              <Form.Group>
          ...
          <div className="d-flex flex-row justify-content-center" style={{ marginLeft: "0px", width: "100%", color: "white" }}>
